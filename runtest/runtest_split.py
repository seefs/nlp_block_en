...
# Single sentence test-word segmentation effect
    text = [
# Polysemy: 还
#            ["花呗淘金币活动"],
#            ["一种药液箱的容积144L"], 
#            ["可以分期还嘛"], 
#            ["这时量得容器内的水深是16cm"], 
# Error correction, unidentified
#            ["网商贷怎么改借呗"],
#            ["花呗怎么付款不鸟了"], 
# Connection sequence adjustment
#            ["为什么我花呗不可以分期账单"],
#            ["我什么时候才能开花呗"],
# Refine
#            ["我想买个浴缸，花呗额度不够怎么办"],
...
# Single sentence test-unadjusted sentence
#    text = [
#            ["花呗都用在哪里"], 
#            ["花呗都能在哪里购物"], 
